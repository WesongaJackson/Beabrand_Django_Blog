...
urlpatterns = [
    ...
    path('delete_profile/',user_views.delete_profile ,name='delete_account'),
    ...
    path('password_reset_confirm/<uidb64>/<token>/',auth_views.PasswordResetConfirmView.as_view(template_name='UsersApp/password_reset_confirm.html') ,name='password_reset_confirm'),
    path('password_reset_complete/',auth_views.PasswordResetCompleteView.as_view(template_name='UsersApp/password_reset_complete.html') ,name='password_reset_complete'),
